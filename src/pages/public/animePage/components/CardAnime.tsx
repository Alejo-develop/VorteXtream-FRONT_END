    ...
    return (
        <div className="card-anime">
            ...
            <div className="buttons">
                ...
                <AddFavoritesButtonComponent size={'0.5rem'} height={'2px'} fontweight={'0.8'} mediaId={id} backdrop_path={image_url} title={title_japonese} overview={synopsis} vote_average={score} typeMedia='anime' />
            </div>
